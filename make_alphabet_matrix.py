...
# row: (gk?, source, Phoen, Greek, Etrus, ClassicalLatin(~0 AD), LaterLatin, note, ModernGreek)
rows = [
 (0,S("ʔalp · ox","אֶלֶף","elef","thousand"),
   ...
   MG("Α α","/a/","álfa","same")),
 (0,S("bayt · house","בַּיִת","bayit","house"),
   ...
   MG("Β β","/v/","víta","chg")),
 (0,S("gaml · camel","גָּמָל","gamal","camel"),
   ...
   MG("Γ γ","/ɣ/","gámma","chg")),
 (0,S("dalt · door","דֶּלֶת","delet","door"),
   ...
   MG("Δ δ","/ð/","délta","chg")),
 (0,S("— uncertain","הֵא","he","name only"),
 ...
 (0,S("zayin · weapon","זַיִן","zayin","weapon"),
   ...
   MG("Ζ ζ","/z/","zíta","chg")),
 (0,S("gaml · camel","גָּמָל","gamal","(via C)",ghost=True),
 ...
 (0,S("ḥet · fence?","חֵית","ḥet","name only"),
 ...
 (0,S("yad · hand","יָד","yad","hand"),
   ...
   MG("Ι ι","/i/","ióta","same")),
 (0,S("yad · hand","יָד","yad","(via I)",ghost=True),
 ...
 (0,S("nun · fish","נוּן","nun","fish = dag"),
   ...
   MG("Ν ν","/n/","ni","same")),
 (1,S("samek · prop","ס","samekh","support"),
 ...
 (0,S("pe · mouth","פֶּה","pe","mouth"),
   P("𐤐","/p/","orig"),G("Π","/p/","same"),T("𐌐","/p/","same"),L("P","/p/","same"),LL("P","W. Rom. p→b→v"),
   "<i>Stable throughout.</i>",
   MG("Π π","/p/","pi","same")),
 (1,S("ṣade · fish-hook?","צ","tsade","name only"),
 ...
 (0,S("— uncertain","קוֹף","qof","monkey (mod.)"),
 ...
 (0,S("waw · hook","וָו","vav","(via Υ)",ghost=True),
   ...
   MG("Υ υ","/i/","ípsilon","chg",ghost=True)),
 (0,S("waw · hook","וָו","vav","(via V)",ghost=True),
 ...
 (1,S("— Greek invention","","",""),
   ...
   MG("Φ φ","/f/","fi","chg")),
 (0,S("samek · prop","סָמֶך","samekh","(via Χ)",ghost=True),
...
trs = []
for gk, src, ph, gr, et, classical, later, note, mg in rows:
